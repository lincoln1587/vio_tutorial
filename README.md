...
Ubuntu 20.04: [http://wiki.ros.org/noetic/Installation/Ubuntu](http://wiki.ros.org/noetic/Installation/Ubuntu).
...
```bash
$ git clone https://github.com/lincoln1587/vio_tutorial.git
```
